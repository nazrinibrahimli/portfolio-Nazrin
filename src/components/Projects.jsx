  ...
  return (
    <div className='projects-div'>
     ...
     <Col><TwiceCard  link="https://agency-website-sage.vercel.app/" title="A'gency" image={agency} info="A'gency website is a fully responsive and written with Next.js,Tailwind, and MUI. "/>
        ...
        <Col><TwiceCard link="https://dejavu-medical-clinic.vercel.app/" title="Dejavu Clinic" image={dejavu}  info="Website of Dejavu Clinic that is written in React, Next JS, Mui and Tailwind CSS . It is a fully responsive website." />
        </Col>
        </Row>
        <Row>
